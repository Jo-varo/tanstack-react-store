...
export const ProductCard = ({
  ...
  return (
    ...
    >
      <Card className="relative flex flex-col md:flex-rw md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white h-full">
